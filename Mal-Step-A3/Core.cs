...
namespace JKLApp
{
    class Core
    {
        ...
        public static JKLFunc BuiltinMeta = new JKLFunc(args =>
        {
            ...
            {
                throw new JKLEvalError("meta expected a function as argument but got '" + args[0].ToString(true) + "'");
            }
        });
        ...
        public static JKLFunc BuiltinWithMeta = new JKLFunc(args =>
        {
            ...
            {
                throw new JKLEvalError("with-meta expected a function as its first argument but got '" + args[0].ToString(true) + "'");
            }
        });
        ...
        public static Dictionary<string, JKLFunc> JKLNameSpace = new Dictionary<string, JKLFunc>
        {
            ...
            // These are defined in Mal itself but I've left the builiIns in the C# code base.
//            {"fn?", BuiltinIsFuncP},
