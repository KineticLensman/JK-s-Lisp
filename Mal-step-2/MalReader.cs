    ...
    public class MalReader
    {
        ...
        public class Reader
        {
            ...
            public string Next()
            {
                ...
                {
                    throw new MalParseError("INTERNAL - Tried to read an empty token queue.");
                }
        ...
        static public MalSeq read_list(Reader reader, MalSeq sequence, char start, char end)
        {
            ...
            if (token[0] != start)
            {
                ...
                throw new MalParseError("INTERNAL - sequence expected '" + start + "' but got: " + token);
            }
        ...
        static public MalVal read_atom(Reader reader)
        {
            ...
            {
                throw new MalParseError("INTERNAL - reader has returned empty string");
            }
