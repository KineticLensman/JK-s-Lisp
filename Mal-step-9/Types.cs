...
namespace Mal
{
    ...
    public class Types
    {
        ...
        // Errors explicitly trapped by Mal programmers from within Mal code.
        public class MalMalError : MalException
        {
            private MalVal myException;

            public MalMalError(MalVal exceptionVal) : base(exceptionVal.ToString(true))
            {
                myException = exceptionVal;
            }
            public MalVal GetExceptionValue ()
            {
                return myException;
            }
        }
